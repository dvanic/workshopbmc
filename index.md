...
{% elsif page.carpentry == "sih" %}
  {% include sih/intro.html %}
{% elsif page.carpentry == "sip" %}
  {% include sip/intro.html %}
{% endif %}
...
{% elsif page.carpentry == "lc" %}
  {% include lc/who.html %}
{% elsif page.carpentry == "sih" %}
  {% include sih/who.html %}
{% elsif page.carpentry == "sip" %}
  {% include sip/who.html %}
{% endif %}
...
<p id="requirements">
  ...
  <a href="#setup">below</a>). <!--- Remove comment DV They are also required to abide by
  {% if page.carpentry == "swc" %}
...
<!---Remove comment if you want this DV
...
{% elsif page.carpentry == "sih" %}
  {% include sih/schedule.html %}
{% elsif page.carpentry == "sip" %}
  {% include sip/schedule.html %}
{% endif %}
